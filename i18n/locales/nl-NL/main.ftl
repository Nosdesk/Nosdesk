...
admin-sla-schedule-add-hours = Uren toevoegen
admin-sla-schedule-add-range-aria = Nog een bereik toevoegen
admin-sla-schedule-remove-range-aria = Dit bereik verwijderen
admin-sla-schedule-open-aria = Openingstijd
admin-sla-schedule-close-aria = Sluitingstijd
admin-sla-schedule-empty-hint = Geen werkuren ingesteld. SLA-timers blijven gepauzeerd totdat ten minste één dag uren heeft.
