...
onboarding-error-token-expired = Het installatietoken is verlopen. Start de server opnieuw op om een nieuw token te genereren.
...
onboarding-error-token-not-present = Installatie is gesloten. Er is geen installatietoken beschikbaar op de server.
