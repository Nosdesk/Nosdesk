...
admin-sla-schedule-add-hours = Ajouter des heures
admin-sla-schedule-add-range-aria = Ajouter une autre plage
admin-sla-schedule-remove-range-aria = Supprimer cette plage
admin-sla-schedule-open-aria = Heure d'ouverture
admin-sla-schedule-close-aria = Heure de fermeture
admin-sla-schedule-empty-hint = Aucune heure ouvrée configurée. Les minuteurs SLA restent en pause tant qu'au moins un jour n'a pas d'heures.
