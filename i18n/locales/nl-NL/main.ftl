...
device-detail-section-kind = Activatype
device-detail-field-kind = Type
...
route-title-devices = Apparaten
route-title-device-create = Apparaat aanmaken
route-title-device-view = Apparaatdetails
...
plugin-permission-device-read-label = Apparaten lezen
plugin-permission-device-read-description = Apparaatgegevens lezen
plugin-permission-device-write-label = Apparaten schrijven
plugin-permission-device-write-description = Apparaten aanmaken en bijwerken
...
device-modal-title = Apparaat selecteren
device-modal-search-placeholder = Zoek apparaten op naam, hostnaam, serienummer, fabrikant of gebruiker...
device-modal-owner = Eigenaar
device-modal-unassigned = Niet toegewezen
device-modal-col-device = Apparaat
device-modal-col-status = Status
device-modal-col-serial = Serie
device-modal-col-user = Gebruiker
