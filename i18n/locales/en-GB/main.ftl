...
ticket-comments-placeholder-public = Add a new comment... (@ to mention, # for a ticket)
ticket-comments-placeholder-internal = Note for the team... (@ to mention, # for a ticket)
