...
onboarding-error-token-expired = Ce lien de configuration a expiré — il n'est valable qu'environ 30 minutes après le démarrage du serveur. Redémarrez le serveur pour générer un nouveau lien, puis utilisez-le pour créer votre compte administrateur.
...
onboarding-error-token-not-present = Ce lien de configuration n'est plus valable — le jeton à usage unique n'est valable qu'environ 30 minutes après le démarrage du serveur, puis il est supprimé. Aucun compte administrateur n'existe encore : redémarrez le serveur pour générer un nouveau lien et terminer la configuration.
