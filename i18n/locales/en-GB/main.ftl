...
empty-asset-search-prompt-title = Search for devices
empty-asset-search-prompt-description = Start typing to find devices by name, serial number, or user
empty-asset-search-title = No devices found
...
empty-assets-default-title = No devices found
empty-assets-default-description = Add your first device to get started
empty-assets-search-title = No devices match your search
...
admin-asset-kinds-field-slug-placeholder = e.g. plumbing_part
...
admin-msgraph-subtitle = Manage data synchronisation from Microsoft 365 services
...
admin-msgraph-last-sync-title = Last Synchronisation
...
admin-msgraph-modal-info = Synchronisation will import the latest data from Microsoft services. This may take several minutes depending on the amount of data.
...
admin-plugins-registry-disabled-description-sideload = This instance has NOSDESK_REGISTRY_URL set to empty, so it isn't fetching the published plugin catalogue. You can still sideload a signed zip.
admin-plugins-registry-disabled-description-cli = This instance has NOSDESK_REGISTRY_URL set to empty, so it isn't fetching the published plugin catalogue. Use the CLI to install local-signed plugins.
admin-plugins-registry-disabled-action = Sideload signed zip
admin-plugins-registry-pending-title = Registry is syncing
admin-plugins-registry-pending-description = The instance is fetching the published plugin catalogue. This usually completes within a few seconds of boot.
...
user-mgmt-column-assets = Devices
...
user-profile-assets-title = Devices
user-profile-assets-empty = No devices
...
user-profile-error-created-no-uuid = User created but navigation failed. Please go to the users list.
...
groups-mgmt-sort-assets = Devices
...
group-detail-field-last-synced = Last synchronised
...
assets-list-search-placeholder = Search devices...
assets-list-item-label = device
...
assets-list-column-device = Device
...
assets-list-bulk-action-error = Failed to delete devices. Please try again.
...
asset-detail-delete-item-name = Device
asset-detail-error-invalid-id = Invalid device ID
asset-detail-error-load = Failed to load device details
asset-detail-error-create = Failed to create device. Please try again.
asset-detail-error-delete = Failed to delete device. Please try again.
asset-detail-error-unmanage = Failed to unmanage device. Please try again.
asset-detail-section-details = Device Details
asset-detail-section-kind = Asset Kind
asset-detail-field-kind = Kind
asset-detail-field-name = Name
asset-detail-field-name-placeholder-create = Enter device name
...
asset-detail-field-model-placeholder-create = Enter device model
...
asset-detail-no-user-assigned = No user assigned to this device
...
asset-detail-action-create = Create device
asset-detail-action-create-processing = Creating...
asset-detail-not-found = Device not found
...
docs-trash-title = Rubbish bin
docs-trash-heading = Rubbish bin
...
docs-trash-loading = Loading deleted pages
...
collection-overrides-summary = { $count ->
    [one] { $count } page with customised permissions
   *[other] { $count } pages with customised permissions
   }
...
csv-import-notes-updates = Existing records will be updated if they share a unique identifier (such as email or ID)
...
settings-mfa-setup-init-error = Failed to initialise MFA setup
settings-mfa-setup-not-ready = MFA setup not initialised properly
...
ticket-media-attachment-format-unsupported = This image format isn't supported by your browser
...
ticket-media-voice-mic-error = Couldn't access the microphone. Please check your permissions.
...
ticket-media-video-fullscreen-enter = Enter full screen
ticket-media-video-fullscreen-exit = Exit full screen
...
ticket-media-pdf-fullscreen = Full screen
ticket-media-pdf-fullscreen-aria = Open full screen
...
ticket-media-file-thumbnail-error = Couldn't generate thumbnail
ticket-media-file-image-error = Couldn't load image
...
settings-profile-signature-hint-prefix = Appended to your outbound replies on channel-originated tickets (email). Separator is the standard
...
admin-groups-config-search-devices = Search devices by name, hostname, serial number...
...
admin-groups-config-unmanage-message = The group will no longer synchronise with Microsoft Entra ID. Manual edits become allowed, but existing sync history is preserved.
...
admin-groups-config-error-devices = Failed to update devices
...
admin-groups-config-success-devices = Devices updated successfully
...
views-saved-editor-confirm-message = Delete "{ $name }"? This cannot be undone, recreate the view if you need it back.
...
settings-appearance-theme-description = Choose your preferred colour scheme
...
settings-appearance-colorblind-description-default = Use distinct shapes for status indicators instead of relying only on colours
...
dashboard-my-assets-title = My devices
dashboard-my-assets-error = Failed to load devices
dashboard-my-assets-empty-title = No devices assigned
dashboard-my-assets-empty-description = Devices linked to your account will show here.
...
ui-user-selection-modal-role-technician = Technician
ui-user-selection-modal-role-user = User
ui-user-card-role-admin = Admin
ui-user-card-role-technician = Technician
...
search-global-prompt-subtitle = Find tickets, documentation, devices and more
...
plugin-permission-asset-read-label = Read Devices
plugin-permission-asset-read-description = Read device data
plugin-permission-asset-write-label = Write Devices
plugin-permission-asset-write-description = Create and update devices
...
asset-modal-title = Select a device
asset-modal-search-placeholder = Search devices by name, hostname, serial number, manufacturer, or user...
asset-modal-owner = Owner
asset-modal-unassigned = Unassigned
asset-modal-col-device = Device
...
calendar-anchor-tooltip = The anchor field is set by the saved view; the picker will land in a future update.
...
auth-mfa-setup-failed = Failed to set up MFA
...
auth-passkey-login-failed = Failed to log in with passkey
...
asset-modal-load-failed = Failed to load devices. Please try again.
...
tickets-column-devices = Devices
