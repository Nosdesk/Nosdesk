...
onboarding-error-token-expired = Le jeton de configuration a expiré. Redémarrez le serveur pour en générer un nouveau.
...
onboarding-error-token-not-present = La configuration est fermée. Aucun jeton de configuration n'est disponible sur le serveur.
