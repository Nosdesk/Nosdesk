 ...
 *
 * The backend sets a `csrf_token` cookie (`__Host-csrf_token` on https) and
 * requires it echoed in the `X-CSRF-Token` header on state-changing
 * requests. `apiClient` injects
