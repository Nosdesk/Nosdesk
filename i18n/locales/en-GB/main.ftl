...
device-detail-section-kind = Asset Kind
device-detail-field-kind = Kind
...
dashboard-my-devices-error = Failed to load devices
dashboard-my-devices-empty-title = No devices assigned
dashboard-my-devices-empty-description = Devices linked to your account will show here.
...
device-modal-title = Select a device
device-modal-search-placeholder = Search devices by name, hostname, serial number, manufacturer, or user...
