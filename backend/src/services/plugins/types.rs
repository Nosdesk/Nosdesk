...
impl Permission {
    pub fn parse(s: &str) -> Result<Self, PermissionError> {
        ...
        match s {
            ...
            "device:read" => Ok(Permission::DeviceRead),
            "device:write" => Ok(Permission::DeviceWrite),
    ...
    pub fn as_string(&self) -> String {
        match self {
            ...
            Permission::DeviceRead => "device:read".to_string(),
            Permission::DeviceWrite => "device:write".to_string(),
