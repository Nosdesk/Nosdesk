...
export const WEBHOOK_EVENTS: WebhookEvent[] = [
  ...
  { value: 'asset.linked',          labelKey: 'admin-webhooks-event-asset-linked',          categoryKey: 'admin-webhooks-category-assets',        category: 'Assets' },
  { value: 'asset.unlinked',        labelKey: 'admin-webhooks-event-asset-unlinked',        categoryKey: 'admin-webhooks-category-assets',        category: 'Assets' },
  { value: 'asset.updated',         labelKey: 'admin-webhooks-event-asset-updated',         categoryKey: 'admin-webhooks-category-assets',        category: 'Assets' },
