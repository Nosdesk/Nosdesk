...
assets-list-bulk-action-error = Couldn't delete devices. Please try again.
...
asset-detail-error-load = Couldn't load device details
asset-detail-error-create = Couldn't create device. Please try again.
asset-detail-error-delete = Couldn't delete device. Please try again.
...
dashboard-my-assets-error = Couldn't load devices
dashboard-my-assets-empty-title = No devices assigned
dashboard-my-assets-empty-description = Devices linked to your account will show up here.
...
asset-modal-title = Pick a device
asset-modal-search-placeholder = Search devices by name, hostname, serial, maker, or user...
...
asset-modal-load-failed = Couldn't load devices. Try again.
